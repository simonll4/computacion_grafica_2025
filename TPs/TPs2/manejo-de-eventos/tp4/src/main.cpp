// src/main.cpp — TP4 Guía 2 (Manejo de eventos)
// Rotación continua respecto del VÉRTICE SUPERIOR.
// Click izq.: fija un nuevo pivote y reposiciona el triángulo para que su top-vertex
//             coincida con ese pivote (queda anclado y rota alrededor de él).
